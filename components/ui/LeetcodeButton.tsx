...
export const LeetcodeButton: React.FC<LeetcodeButtonProps> = ({
  href = "https://leetcode.com/u/manav_valani/",
  className = "",
}) => {
  return (
    <a
    ...
    >
      ...
      <span className="absolute inset-0 origin-bottom rounded-[10px] bg-[#FFA116] transition-transform duration-300 ease-out z-0 group-hover:rotate-35 pointer-events-none opacity-90" />

      {/* Main glass button */}
      <span className="relative z-10 w-full h-full flex items-center justify-center bg-transparent border border-[rgba(156,156,156,0.466)] rounded-[10px] transition-all duration-300 group-hover:bg-[#FFA116]/20 group-hover:backdrop-blur-xs">
        <svg
