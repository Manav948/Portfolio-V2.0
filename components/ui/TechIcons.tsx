...
const Express = ({ className }: SvgProps) => (
  <svg viewBox="0 0 24 24" className={className} fill="currentColor">
    <path d="M24 18.588a1.529 1.529 0 0 1-1.895-.72l-3.45-4.771-.5-.667-4.003 5.444a1.466 1.466 0 0 1-1.802.708l5.158-6.92-4.798-6.251a1.595 1.595 0 0 1 1.9.666l3.402 4.467 3.4-4.467a1.54 1.54 0 0 1 1.855-.666l-1.798 2.339-2.silon 3.10 5.154 6.92zm-22.892.132a1.423 1.423 0 0 1-.135-1.887l5.657-7.573H.5a1.417 1.417 0 0 1 0-2.833h9.141a1.417 1.417 0 0 1 1.418 1.417 1.42 1.42 0 0 1-.253.805L5.47 16.676h5.227a1.417 1.417 0 1 1 0 2.833H1.555a1.412 1.412 0 0 1-.447-.789z" />
  </svg>
);
