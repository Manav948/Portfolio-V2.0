...
const TechBubble = ({ name }: { name: string }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-3.75 h-3.75 flex items-center justify-center">
...
const GithubIcon = () => (
  <svg fill="currentColor" viewBox="0 0 496 512" className="w-4.25 h-4.25">
...
export const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div
      ...
      className="group relative w-full rounded-[18px] border border-neutral-200/80 dark:border-neutral-800/60 bg-neutral-100 dark:bg-neutral-950 shadow-sm hover:shadow-xl hover:-translate-y-0.75 hover:border-neutral-300 dark:hover:border-neutral-700/60 transition-all duration-300 overflow-hidden"
    >
      
      <div
        ref={blobRef}
        className="pointer-events-none absolute z-0 w-37.5 h-37.5 rounded-full blur-2xl transition-opacity duration-500"
        style={{
          background:
      ...
      <div className="relative z-10 m-[1.5px] rounded-[16.5px] bg-white dark:bg-neutral-900 flex flex-col" style={{overflow: "clip"}}>
        ...
        <div className="p-4 flex flex-col gap-2.5 flex-1">
          ...
          <p className="text-[12.5px] leading-[1.6] text-neutral-500 dark:text-neutral-450 font-normal line-clamp-2 min-h-10">
            {description}
          </p>
